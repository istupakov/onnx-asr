...
- **Audio recognition fails**: Most models support up to 20-30 seconds of audio. For longer files, use [VAD](usage.md#vad-voice-activity-detection) for segmentation.
